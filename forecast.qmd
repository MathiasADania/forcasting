...
#| message: false
#| warning: false
jernbanedata_rå <- read_excel("data/jernbanetransport af passagerer.xlsx",
                           sheet = "BANE25"
                           )
```

```{r}
#| label: klargøring-data
#| message: false
#| warning: false
jernbanedata <- jernbanedata_rå %>%
  clean_names() %>%
